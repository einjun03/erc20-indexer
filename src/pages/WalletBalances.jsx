...
function WalletBalances() {
  ...
  return (
      <div className="relative flex flex-col min-h-screen text-center w-full bg-base-100">
        ...
        <div className='sticky top-10 z-10 p-8 rounded-2xl flex justify-center items-center'>
          ...
          <div className='flex w-full justify-center items-center mt-4 px-10 py-5 pt-20'>
            ...
            {state === 'Idle' ? <p className='text-2xl font-semibold text-primary'>Search to Display Balances</p> : 
